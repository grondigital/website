...
$(function() {
	...
	var roundDates = [
		...
		new Date('2018-03-15T00:00:00Z').getTime(), //round 1
		new Date('2018-03-29T00:00:00Z').getTime(), //round 2
		new Date('2018-04-12T00:00:00Z').getTime(), //round 3
		new Date('2018-04-26T00:00:00Z').getTime()  //round 4
	];
